...
import io.github.celebes.hazelcast.test.samples.parameters.BookParameters;
...
public class Book implements EntityObject {
	...
	@Transient
	private BookParameters bookParameters;
	...
	public BookParameters getBookParameters() {
		return bookParameters;
	}

	public void setBookParameters(BookParameters bookParameters) {
